...
%>
	...
	<div class="content"><!-- 접수. 상담 관리 -->
		<select name="prNo" onchange="movePage('AdviceAccept.jsp','prNo',this.value);"><!-- 과정 선택 -->
			<option></option>
			<%
				for(int i = 0; i < pList.size(); i++){
					if(pList.get(i).getPrStateName().equals("개강전")){		//과정 상태 개강전만 출력
